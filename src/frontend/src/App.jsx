...
function App() {
  ...
  const [interval, setSelectedInterval] = useState("weekly");
  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ width: "100%", height: 300 }}>
        <ResponsiveContainer>
          <LineChart data={activity}>
            <XAxis dataKey={interval === "daily" ? "date" : interval === "monthly" ? "month" : "week"} />
            <YAxis />
            <Tooltip />
      ...
      {speeches.map((speech, index) => (
        <div key={index} style={{ marginBottom: "1.5rem", borderBottom: "1px solid #ddd" }}>
